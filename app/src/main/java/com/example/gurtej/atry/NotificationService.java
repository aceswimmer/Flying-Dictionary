...
import com.example.gurtej.atry.R;
import com.example.gurtej.atry.LogoActivity;
import com.example.gurtej.atry.PopUpActivity;
...
*/
        ...
        if(spref.getBoolean(SettingsActivity.NOTIFY_CHECK,true)==true)
